Shader "Skybox/Transition" {    
    Properties{
		...
		_Rotation1("Rotation1", Range(0, 360)) = 90
		_Rotation2("Rotation2", Range(0, 360)) = 90
        _Rotation3("Rotation3", Range(0, 360)) = 90
		[NoScaleOffset] _Texture1("Clouds", 2D) = "grey" {}
		[NoScaleOffset] _Texture2("Atmosphere", 2D) = "grey" {}
        [NoScaleOffset] _Texture3("Space", 2D) = "grey" {}
    ...
    SubShader{
        ...
        Pass {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                tc.x = frac(tc.x + (_Rotation3 - _Rotation2) / 360.0);
                half4 tex3 = tex2D(_Texture3, tc);
                ...
                if (_Blend <= 1) {
                    ...
                    c2 = lerp(c2, c3, _Blend - 1) * lerp(_Tint2.rgb, _Tint3.rgb, _Blend - 1) * unity_ColorSpaceDouble.rgb * lerp(_Exposure2, _Exposure3, _Blend - 1);
                    return half4(c2, 1);
                }
            }
            ENDCG
